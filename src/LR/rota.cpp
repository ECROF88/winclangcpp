...
void calculatePlane(const float& cube_x, const float& cube_y,
                    const float& cube_z, const char& ch)
{
...
int main()
{
  ...
  while (true) {
    ...
    for (float cube_x = -cube_width; cube_x < cube_width;
         cube_x += incrementSpeed) {
      for (float cube_y = -cube_width; cube_y < cube_width;
           cube_y += incrementSpeed) {
